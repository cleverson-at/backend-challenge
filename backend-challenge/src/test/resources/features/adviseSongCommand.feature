Feature: Check the song suggestions
  ...
  Scenario: Get Classic songs suggested
    Given the temperature is greater than or equal to 15 degrees Celsius
    And lower than or equal to 20
    When I check the song suggestions
    Then I get songs of the Classic category suggested
    
  Scenario: Get Hip Hop songs suggested
    Given the temperature is greater than or equal to 21 degrees Celsius
    And lower than or equal to 30
    When I check the song suggestions
